...
int Find(char* haystack, char* needle) {
  ...
  while ((i) <= ((strlen(haystack)) - (strlen(needle)))) {
    if ((haystack[i]) != (c)) {
      ...
      int tmp_strlen29999 = ((i) + (strlen(needle))) - (i) + 1;
      char* tmp_str29999 = calloc(tmp_strlen29999, sizeof(char));
      strncpy(tmp_str29999, haystack + i, tmp_strlen29999 - 1);
      tmp_str29999[tmp_strlen29999 - 1] = 0;
      if ((strcmp(tmp_str29999, needle) != 0)) {
        i = (i) + (1);
        continue;
      }
    }
...
bool StartsWith(char* text, char* prefix) {
  if ((strlen(text)) < (strlen(prefix))) {
    ...
    if ((strlen(text)) == (strlen(prefix))) {
      ...
      int tmp_strlen29665 = (strlen(prefix)) - (0) + 1;
      char* tmp_str29665 = calloc(tmp_strlen29665, sizeof(char));
      strncpy(tmp_str29665, text + 0, tmp_strlen29665 - 1);
      tmp_str29665[tmp_strlen29665 - 1] = 0;
      return (strcmp(tmp_str29665, prefix) == 0);
    }
  }
}
...
char* RemoveLeadingWhitespace(char* text) {
  while ((StartsWith(text, " ")) || (StartsWith(text, "\t"))) {
    int tmp_strlen29270 = (strlen(text)) - (1) + 1;
    char* tmp_str29270 = calloc(tmp_strlen29270, sizeof(char));
    strncpy(tmp_str29270, text + 1, tmp_strlen29270 - 1);
    tmp_str29270[tmp_strlen29270 - 1] = 0;
    text = tmp_str29270;
  }
  return text;
}
...
Next_results Next(char* src) {
  ...
  if ((strcmp(src, "") == 0)) {
    ...
    if (StartsWith(src, "->")) {
      int tmp_strlen29047 = (strlen(src)) - (2) + 1;
      char* tmp_str29047 = calloc(tmp_strlen29047, sizeof(char));
      strncpy(tmp_str29047, src + 2, tmp_strlen29047 - 1);
      tmp_str29047[tmp_strlen29047 - 1] = 0;
      return (Next_results){tmp_str29047, TOK_RARROW, "->"};
    } else {
      if (StartsWith(src, "||")) {
        int tmp_strlen28968 = (strlen(src)) - (2) + 1;
        char* tmp_str28968 = calloc(tmp_strlen28968, sizeof(char));
        strncpy(tmp_str28968, src + 2, tmp_strlen28968 - 1);
        tmp_str28968[tmp_strlen28968 - 1] = 0;
        return (Next_results){tmp_str28968, TOK_BOR, "||"};
      } else {
        if (StartsWith(src, "&&")) {
          int tmp_strlen28892 = (strlen(src)) - (2) + 1;
          char* tmp_str28892 = calloc(tmp_strlen28892, sizeof(char));
          strncpy(tmp_str28892, src + 2, tmp_strlen28892 - 1);
          tmp_str28892[tmp_strlen28892 - 1] = 0;
          return (Next_results){tmp_str28892, TOK_BAND, "&&"};
        } else {
          if (StartsWith(src, "==")) {
            int tmp_strlen28815 = (strlen(src)) - (2) + 1;
            char* tmp_str28815 = calloc(tmp_strlen28815, sizeof(char));
            strncpy(tmp_str28815, src + 2, tmp_strlen28815 - 1);
            tmp_str28815[tmp_strlen28815 - 1] = 0;
            return (Next_results){tmp_str28815, TOK_EQ, "=="};
          } else {
            if (StartsWith(src, "!=")) {
              int tmp_strlen28740 = (strlen(src)) - (2) + 1;
              char* tmp_str28740 = calloc(tmp_strlen28740, sizeof(char));
              strncpy(tmp_str28740, src + 2, tmp_strlen28740 - 1);
              tmp_str28740[tmp_strlen28740 - 1] = 0;
              return (Next_results){tmp_str28740, TOK_NEQ, "!="};
            } else {
              if (StartsWith(src, "<=")) {
                int tmp_strlen28664 = (strlen(src)) - (2) + 1;
                char* tmp_str28664 = calloc(tmp_strlen28664, sizeof(char));
                strncpy(tmp_str28664, src + 2, tmp_strlen28664 - 1);
                tmp_str28664[tmp_strlen28664 - 1] = 0;
                return (Next_results){tmp_str28664, TOK_LEQ, "<="};
              } else {
                if (StartsWith(src, ">=")) {
                  int tmp_strlen28588 = (strlen(src)) - (2) + 1;
                  char* tmp_str28588 = calloc(tmp_strlen28588, sizeof(char));
                  strncpy(tmp_str28588, src + 2, tmp_strlen28588 - 1);
                  tmp_str28588[tmp_strlen28588 - 1] = 0;
                  return (Next_results){tmp_str28588, TOK_GEQ, ">="};
                } else {
                  if (StartsWith(src, "++")) {
                    int tmp_strlen28512 = (strlen(src)) - (2) + 1;
                    char* tmp_str28512 = calloc(tmp_strlen28512, sizeof(char));
                    strncpy(tmp_str28512, src + 2, tmp_strlen28512 - 1);
                    tmp_str28512[tmp_strlen28512 - 1] = 0;
                    return (Next_results){tmp_str28512, TOK_STRCAT, "++"};
                  } else {
                    if (StartsWith(src, "<>")) {
                      int tmp_strlen28433 = (strlen(src)) - (2) + 1;
                      char* tmp_str28433 = calloc(tmp_strlen28433, sizeof(char));
                      strncpy(tmp_str28433, src + 2, tmp_strlen28433 - 1);
                      tmp_str28433[tmp_strlen28433 - 1] = 0;
                      return (Next_results){tmp_str28433, TOK_STREQ, "<>"};
                    } else {
                      if (StartsWith(src, "<!>")) {
                        int tmp_strlen28354 = (strlen(src)) - (3) + 1;
                        char* tmp_str28354 = calloc(tmp_strlen28354, sizeof(char));
                        strncpy(tmp_str28354, src + 3, tmp_strlen28354 - 1);
                        tmp_str28354[tmp_strlen28354 - 1] = 0;
                        return (Next_results){tmp_str28354, TOK_STRNEQ, "<!>"};
                      } else {
                        if (StartsWith(src, "\n")) {
                          int tmp_strlen28274 = (strlen(src)) - (1) + 1;
                          char* tmp_str28274 = calloc(tmp_strlen28274, sizeof(char));
                          strncpy(tmp_str28274, src + 1, tmp_strlen28274 - 1);
                          tmp_str28274[tmp_strlen28274 - 1] = 0;
                          return (Next_results){tmp_str28274, TOK_NEWLINE, "\n"};
                        } else {
                          if (StartsWith(src, "(")) {
                            int tmp_strlen28195 = (strlen(src)) - (1) + 1;
                            char* tmp_str28195 = calloc(tmp_strlen28195, sizeof(char));
                            strncpy(tmp_str28195, src + 1, tmp_strlen28195 - 1);
                            tmp_str28195[tmp_strlen28195 - 1] = 0;
                            return (Next_results){tmp_str28195, TOK_LPAREN, "("};
                          } else {
                            if (StartsWith(src, ")")) {
                              int tmp_strlen28118 = (strlen(src)) - (1) + 1;
                              char* tmp_str28118 = calloc(tmp_strlen28118, sizeof(char));
                              strncpy(tmp_str28118, src + 1, tmp_strlen28118 - 1);
                              tmp_str28118[tmp_strlen28118 - 1] = 0;
                              return (Next_results){tmp_str28118, TOK_RPAREN, ")"};
                            } else {
                              if (StartsWith(src, "[")) {
                                int tmp_strlen28041 = (strlen(src)) - (1) + 1;
                                char* tmp_str28041 = calloc(tmp_strlen28041, sizeof(char));
                                strncpy(tmp_str28041, src + 1, tmp_strlen28041 - 1);
                                tmp_str28041[tmp_strlen28041 - 1] = 0;
                                return (Next_results){tmp_str28041, TOK_LBRACKET, "["};
                              } else {
                                if (StartsWith(src, "]")) {
                                  int tmp_strlen27962 = (strlen(src)) - (1) + 1;
                                  char* tmp_str27962 = calloc(tmp_strlen27962, sizeof(char));
                                  strncpy(tmp_str27962, src + 1, tmp_strlen27962 - 1);
                                  tmp_str27962[tmp_strlen27962 - 1] = 0;
                                  return (Next_results){tmp_str27962, TOK_RBRACKET, "]"};
                                } else {
                                  if (StartsWith(src, "{")) {
                                    int tmp_strlen27883 = (strlen(src)) - (1) + 1;
                                    char* tmp_str27883 = calloc(tmp_strlen27883, sizeof(char));
                                    strncpy(tmp_str27883, src + 1, tmp_strlen27883 - 1);
                                    tmp_str27883[tmp_strlen27883 - 1] = 0;
                                    return (Next_results){tmp_str27883, TOK_LCURLY, "{"};
                                  } else {
                                    if (StartsWith(src, "}")) {
                                      int tmp_strlen27806 = (strlen(src)) - (1) + 1;
                                      char* tmp_str27806 = calloc(tmp_strlen27806, sizeof(char));
                                      strncpy(tmp_str27806, src + 1, tmp_strlen27806 - 1);
                                      tmp_str27806[tmp_strlen27806 - 1] = 0;
                                      return (Next_results){tmp_str27806, TOK_RCURLY, "}"};
                                    } else {
                                      if (StartsWith(src, ":")) {
                                        int tmp_strlen27729 = (strlen(src)) - (1) + 1;
                                        char* tmp_str27729 = calloc(tmp_strlen27729, sizeof(char));
                                        strncpy(tmp_str27729, src + 1, tmp_strlen27729 - 1);
                                        tmp_str27729[tmp_strlen27729 - 1] = 0;
                                        return (Next_results){tmp_str27729, TOK_COLON, ":"};
                                      } else {
                                        if (StartsWith(src, ",")) {
                                          int tmp_strlen27653 = (strlen(src)) - (1) + 1;
                                          char* tmp_str27653 = calloc(tmp_strlen27653, sizeof(char));
                                          strncpy(tmp_str27653, src + 1, tmp_strlen27653 - 1);
                                          tmp_str27653[tmp_strlen27653 - 1] = 0;
                                          return (Next_results){tmp_str27653, TOK_COMMA, ","};
                                        } else {
                                          if (StartsWith(src, "=")) {
                                            int tmp_strlen27577 = (strlen(src)) - (1) + 1;
                                            char* tmp_str27577 = calloc(tmp_strlen27577, sizeof(char));
                                            strncpy(tmp_str27577, src + 1, tmp_strlen27577 - 1);
                                            tmp_str27577[tmp_strlen27577 - 1] = 0;
                                            return (Next_results){tmp_str27577, TOK_ASSIGN, "="};
                                          } else {
                                            if (StartsWith(src, "!")) {
                                              int tmp_strlen27500 = (strlen(src)) - (1) + 1;
                                              char* tmp_str27500 = calloc(tmp_strlen27500, sizeof(char));
                                              strncpy(tmp_str27500, src + 1, tmp_strlen27500 - 1);
                                              tmp_str27500[tmp_strlen27500 - 1] = 0;
                                              return (Next_results){tmp_str27500, TOK_BNOT, "!"};
                                            } else {
                                              if (StartsWith(src, "+")) {
                                                int tmp_strlen27425 = (strlen(src)) - (1) + 1;
                                                char* tmp_str27425 = calloc(tmp_strlen27425, sizeof(char));
                                                strncpy(tmp_str27425, src + 1, tmp_strlen27425 - 1);
                                                tmp_str27425[tmp_strlen27425 - 1] = 0;
                                                return (Next_results){tmp_str27425, TOK_ADD, "+"};
                                              } else {
                                                if (StartsWith(src, "-")) {
                                                  int tmp_strlen27351 = (strlen(src)) - (1) + 1;
                                                  char* tmp_str27351 = calloc(tmp_strlen27351, sizeof(char));
                                                  strncpy(tmp_str27351, src + 1, tmp_strlen27351 - 1);
                                                  tmp_str27351[tmp_strlen27351 - 1] = 0;
                                                  return (Next_results){tmp_str27351, TOK_SUB, "-"};
                                                } else {
                                                  if (StartsWith(src, "*")) {
                                                    int tmp_strlen27277 = (strlen(src)) - (1) + 1;
                                                    char* tmp_str27277 = calloc(tmp_strlen27277, sizeof(char));
                                                    strncpy(tmp_str27277, src + 1, tmp_strlen27277 - 1);
                                                    tmp_str27277[tmp_strlen27277 - 1] = 0;
                                                    return (Next_results){tmp_str27277, TOK_MUL, "*"};
                                                  } else {
                                                    if (StartsWith(src, "/")) {
                                                      int tmp_strlen27203 = (strlen(src)) - (1) + 1;
                                                      char* tmp_str27203 = calloc(tmp_strlen27203, sizeof(char));
                                                      strncpy(tmp_str27203, src + 1, tmp_strlen27203 - 1);
                                                      tmp_str27203[tmp_strlen27203 - 1] = 0;
                                                      return (Next_results){tmp_str27203, TOK_DIV, "/"};
                                                    } else {
                                                      if (StartsWith(src, "%")) {
                                                        int tmp_strlen27129 = (strlen(src)) - (1) + 1;
                                                        char* tmp_str27129 = calloc(tmp_strlen27129, sizeof(char));
                                                        strncpy(tmp_str27129, src + 1, tmp_strlen27129 - 1);
                                                        tmp_str27129[tmp_strlen27129 - 1] = 0;
                                                        return (Next_results){tmp_str27129, TOK_REM, "%"};
                                                      } else {
                                                        if (StartsWith(src, "~")) {
                                                          int tmp_strlen27055 = (strlen(src)) - (1) + 1;
                                                          char* tmp_str27055 = calloc(tmp_strlen27055, sizeof(char));
                                                          strncpy(tmp_str27055, src + 1, tmp_strlen27055 - 1);
                                                          tmp_str27055[tmp_strlen27055 - 1] = 0;
                                                          return (Next_results){tmp_str27055, TOK_INOT, "~"};
                                                        } else {
                                                          if (StartsWith(src, "|")) {
                                                            int tmp_strlen26980 = (strlen(src)) - (1) + 1;
                                                            char* tmp_str26980 = calloc(tmp_strlen26980, sizeof(char));
                                                            strncpy(tmp_str26980, src + 1, tmp_strlen26980 - 1);
                                                            tmp_str26980[tmp_strlen26980 - 1] = 0;
                                                            return (Next_results){tmp_str26980, TOK_IOR, "|"};
                                                          } else {
                                                            if (StartsWith(src, "&")) {
                                                              int tmp_strlen26906 = (strlen(src)) - (1) + 1;
                                                              char* tmp_str26906 = calloc(tmp_strlen26906, sizeof(char));
                                                              strncpy(tmp_str26906, src + 1, tmp_strlen26906 - 1);
                                                              tmp_str26906[tmp_strlen26906 - 1] = 0;
                                                              return (Next_results){tmp_str26906, TOK_IAND, "&"};
                                                            } else {
                                                              if (StartsWith(src, "^")) {
                                                                int tmp_strlen26831 = (strlen(src)) - (1) + 1;
                                                                char* tmp_str26831 = calloc(tmp_strlen26831, sizeof(char));
                                                                strncpy(tmp_str26831, src + 1, tmp_strlen26831 - 1);
                                                                tmp_str26831[tmp_strlen26831 - 1] = 0;
                                                                return (Next_results){tmp_str26831, TOK_IXOR, "^"};
                                                              } else {
                                                                if (StartsWith(src, "<")) {
                                                                  int tmp_strlen26756 = (strlen(src)) - (1) + 1;
                                                                  char* tmp_str26756 = calloc(tmp_strlen26756, sizeof(char));
                                                                  strncpy(tmp_str26756, src + 1, tmp_strlen26756 - 1);
                                                                  tmp_str26756[tmp_strlen26756 - 1] = 0;
                                                                  return (Next_results){tmp_str26756, TOK_LESS, "<"};
                                                                } else {
                                                                  if (StartsWith(src, ">")) {
                                                                    int tmp_strlen26681 = (strlen(src)) - (1) + 1;
                                                                    char* tmp_str26681 = calloc(tmp_strlen26681, sizeof(char));
                                                                    strncpy(tmp_str26681, src + 1, tmp_strlen26681 - 1);
                                                                    tmp_str26681[tmp_strlen26681 - 1] = 0;
                                                                    return (Next_results){tmp_str26681, TOK_GREATER, ">"};
                                                                  } else {
                                                                    if (IsAlpha(src[0])) {
                                                                      int i = 1;
                                                                      ...
                                                                      i = (i) - (1);
                                                                      int tmp_strlen26451 = (i) - (0) + 1;
                                                                      char* tmp_str26451 = calloc(tmp_strlen26451, sizeof(char));
                                                                      strncpy(tmp_str26451, src + 0, tmp_strlen26451 - 1);
                                                                      tmp_str26451[tmp_strlen26451 - 1] = 0;
                                                                      char* ts = tmp_str26451;
                                                                      int tt;
                                                                      if ((strcmp(ts, "fn") == 0)) {
                                                                        tt = TOK_FN;
                                                                      } else {
                                                                      ...
                                                                      int tmp_strlen25658 = (strlen(src)) - (i) + 1;
                                                                      char* tmp_str25658 = calloc(tmp_strlen25658, sizeof(char));
                                                                      strncpy(tmp_str25658, src + i, tmp_strlen25658 - 1);
                                                                      tmp_str25658[tmp_strlen25658 - 1] = 0;
                                                                      return (Next_results){tmp_str25658, tt, ts};
                                                                    } else {
                                                                      if (IsNumeric(src[0])) {
                                                                        int i = 1;
                                                                        ...
                                                                        int tmp_strlen25490 = (strlen(src)) - (i) + 1;
                                                                        char* tmp_str25490 = calloc(tmp_strlen25490, sizeof(char));
                                                                        strncpy(tmp_str25490, src + i, tmp_strlen25490 - 1);
                                                                        tmp_str25490[tmp_strlen25490 - 1] = 0;
                                                                        int tmp_strlen25470 = (i) - (0) + 1;
                                                                        char* tmp_str25470 = calloc(tmp_strlen25470, sizeof(char));
                                                                        strncpy(tmp_str25470, src + 0, tmp_strlen25470 - 1);
                                                                        tmp_str25470[tmp_strlen25470 - 1] = 0;
                                                                        return (Next_results){tmp_str25490, TOK_INTLIT, tmp_str25470};
                                                                      } else {
                                                                        if (StartsWith(src, "\"")) {
                                                                          int i = 1;
                                                                          while (true) {
                                                                            int tmp_strlen25388 = ((i) + (1)) - (i) + 1;
                                                                            char* tmp_str25388 = calloc(tmp_strlen25388, sizeof(char));
                                                                            strncpy(tmp_str25388, src + i, tmp_strlen25388 - 1);
                                                                            tmp_str25388[tmp_strlen25388 - 1] = 0;
                                                                            if (!((strcmp(tmp_str25388, "\"") != 0))) break;
                                                                            i = (i) + (1);
                                                                            int tmp_strlen25327 = (i) - ((i) - (1)) + 1;
                                                                            char* tmp_str25327 = calloc(tmp_strlen25327, sizeof(char));
                                                                            strncpy(tmp_str25327, src + (i) - (1), tmp_strlen25327 - 1);
                                                                            tmp_str25327[tmp_strlen25327 - 1] = 0;
                                                                            if ((strcmp(tmp_str25327, "\\") == 0)) {
                                                                              i = (i) + (1);
                                                                            }
                                                                          }
                                                                          i = (i) + (1);
                                                                          int tmp_strlen25225 = (strlen(src)) - (i) + 1;
                                                                          char* tmp_str25225 = calloc(tmp_strlen25225, sizeof(char));
                                                                          strncpy(tmp_str25225, src + i, tmp_strlen25225 - 1);
                                                                          tmp_str25225[tmp_strlen25225 - 1] = 0;
                                                                          int tmp_strlen25205 = (i) - (0) + 1;
                                                                          char* tmp_str25205 = calloc(tmp_strlen25205, sizeof(char));
                                                                          strncpy(tmp_str25205, src + 0, tmp_strlen25205 - 1);
                                                                          tmp_str25205[tmp_strlen25205 - 1] = 0;
                                                                          return (Next_results){tmp_str25225, TOK_STRLIT, tmp_str25205};
                                                                        } else {
                                                                          int tmp_strlen25140 = (1) - (0) + 1;
                                                                          char* tmp_str25140 = calloc(tmp_strlen25140, sizeof(char));
                                                                          strncpy(tmp_str25140, src + 0, tmp_strlen25140 - 1);
                                                                          tmp_str25140[tmp_strlen25140 - 1] = 0;
                                                                          int tmp_strlen25137 = strlen("unexpected token start: ") + strlen(tmp_str25140) + 1;
                                                                          char* tmp_str25137 = calloc(tmp_strlen25137, sizeof(char));
                                                                          strcpy(tmp_str25137, "unexpected token start: ");
                                                                          strcat(tmp_str25137, tmp_str25140);
...
TranslateAssignStmt_results TranslateAssignStmt(char* src, char* indent) {
  int x = Find(src, "=");
  int tmp_strlen14154 = (x) - (0) + 1;
  char* tmp_str14154 = calloc(tmp_strlen14154, sizeof(char));
  strncpy(tmp_str14154, src + 0, tmp_strlen14154 - 1);
  tmp_str14154[tmp_strlen14154 - 1] = 0;
  char* lhs = tmp_str14154;
  int tmp_strlen14121 = (strlen(src)) - ((x) + (1)) + 1;
  char* tmp_str14121 = calloc(tmp_strlen14121, sizeof(char));
  strncpy(tmp_str14121, src + (x) + (1), tmp_strlen14121 - 1);
  tmp_str14121[tmp_strlen14121 - 1] = 0;
  char* rhs = tmp_str14121;
  char* lhs_ident;
