...
int Find(char* haystack, char* needle) {
  ...
  while ((i) <= ((strlen(haystack)) - (strlen(needle)))) {
    if ((haystack[i]) != (c)) {
      ...
      int tmp_strlen27791 = ((i) + (strlen(needle))) - (i) + 1;
      char* tmp_str27791 = calloc(tmp_strlen27791, sizeof(char));
      strncpy(tmp_str27791, haystack + i, tmp_strlen27791 - 1);
      tmp_str27791[tmp_strlen27791 - 1] = 0;
      if ((strcmp(tmp_str27791, needle) != 0)) {
        i = (i) + (1);
        continue;
      }
    }
...
bool StartsWith(char* text, char* prefix) {
  if ((strlen(text)) < (strlen(prefix))) {
    ...
    if ((strlen(text)) == (strlen(prefix))) {
      ...
      int tmp_strlen27457 = (strlen(prefix)) - (0) + 1;
      char* tmp_str27457 = calloc(tmp_strlen27457, sizeof(char));
      strncpy(tmp_str27457, text + 0, tmp_strlen27457 - 1);
      tmp_str27457[tmp_strlen27457 - 1] = 0;
      return (strcmp(tmp_str27457, prefix) == 0);
    }
  }
}
...
char* RemoveLeadingWhitespace(char* text) {
  while ((StartsWith(text, " ")) || (StartsWith(text, "\t"))) {
    int tmp_strlen27062 = (strlen(text)) - (1) + 1;
    char* tmp_str27062 = calloc(tmp_strlen27062, sizeof(char));
    strncpy(tmp_str27062, text + 1, tmp_strlen27062 - 1);
    tmp_str27062[tmp_strlen27062 - 1] = 0;
    text = tmp_str27062;
  }
  return text;
}
...
Next_results Next(char* src) {
  ...
  if ((strcmp(src, "") == 0)) {
    ...
    if (StartsWith(src, "->")) {
      int tmp_strlen26839 = (strlen(src)) - (2) + 1;
      char* tmp_str26839 = calloc(tmp_strlen26839, sizeof(char));
      strncpy(tmp_str26839, src + 2, tmp_strlen26839 - 1);
      tmp_str26839[tmp_strlen26839 - 1] = 0;
      return (Next_results){tmp_str26839, TOK_RARROW, "->"};
    } else {
      if (StartsWith(src, "||")) {
        int tmp_strlen26760 = (strlen(src)) - (2) + 1;
        char* tmp_str26760 = calloc(tmp_strlen26760, sizeof(char));
        strncpy(tmp_str26760, src + 2, tmp_strlen26760 - 1);
        tmp_str26760[tmp_strlen26760 - 1] = 0;
        return (Next_results){tmp_str26760, TOK_BOR, "||"};
      } else {
        if (StartsWith(src, "&&")) {
          int tmp_strlen26684 = (strlen(src)) - (2) + 1;
          char* tmp_str26684 = calloc(tmp_strlen26684, sizeof(char));
          strncpy(tmp_str26684, src + 2, tmp_strlen26684 - 1);
          tmp_str26684[tmp_strlen26684 - 1] = 0;
          return (Next_results){tmp_str26684, TOK_BAND, "&&"};
        } else {
          if (StartsWith(src, "==")) {
            int tmp_strlen26607 = (strlen(src)) - (2) + 1;
            char* tmp_str26607 = calloc(tmp_strlen26607, sizeof(char));
            strncpy(tmp_str26607, src + 2, tmp_strlen26607 - 1);
            tmp_str26607[tmp_strlen26607 - 1] = 0;
            return (Next_results){tmp_str26607, TOK_EQ, "=="};
          } else {
            if (StartsWith(src, "!=")) {
              int tmp_strlen26532 = (strlen(src)) - (2) + 1;
              char* tmp_str26532 = calloc(tmp_strlen26532, sizeof(char));
              strncpy(tmp_str26532, src + 2, tmp_strlen26532 - 1);
              tmp_str26532[tmp_strlen26532 - 1] = 0;
              return (Next_results){tmp_str26532, TOK_NEQ, "!="};
            } else {
              if (StartsWith(src, "<=")) {
                int tmp_strlen26456 = (strlen(src)) - (2) + 1;
                char* tmp_str26456 = calloc(tmp_strlen26456, sizeof(char));
                strncpy(tmp_str26456, src + 2, tmp_strlen26456 - 1);
                tmp_str26456[tmp_strlen26456 - 1] = 0;
                return (Next_results){tmp_str26456, TOK_LEQ, "<="};
              } else {
                if (StartsWith(src, ">=")) {
                  int tmp_strlen26380 = (strlen(src)) - (2) + 1;
                  char* tmp_str26380 = calloc(tmp_strlen26380, sizeof(char));
                  strncpy(tmp_str26380, src + 2, tmp_strlen26380 - 1);
                  tmp_str26380[tmp_strlen26380 - 1] = 0;
                  return (Next_results){tmp_str26380, TOK_GEQ, ">="};
                } else {
                  if (StartsWith(src, "++")) {
                    int tmp_strlen26304 = (strlen(src)) - (2) + 1;
                    char* tmp_str26304 = calloc(tmp_strlen26304, sizeof(char));
                    strncpy(tmp_str26304, src + 2, tmp_strlen26304 - 1);
                    tmp_str26304[tmp_strlen26304 - 1] = 0;
                    return (Next_results){tmp_str26304, TOK_STRCAT, "++"};
                  } else {
                    if (StartsWith(src, "<>")) {
                      int tmp_strlen26225 = (strlen(src)) - (2) + 1;
                      char* tmp_str26225 = calloc(tmp_strlen26225, sizeof(char));
                      strncpy(tmp_str26225, src + 2, tmp_strlen26225 - 1);
                      tmp_str26225[tmp_strlen26225 - 1] = 0;
                      return (Next_results){tmp_str26225, TOK_STREQ, "<>"};
                    } else {
                      if (StartsWith(src, "<!>")) {
                        int tmp_strlen26146 = (strlen(src)) - (3) + 1;
                        char* tmp_str26146 = calloc(tmp_strlen26146, sizeof(char));
                        strncpy(tmp_str26146, src + 3, tmp_strlen26146 - 1);
                        tmp_str26146[tmp_strlen26146 - 1] = 0;
                        return (Next_results){tmp_str26146, TOK_STRNEQ, "<!>"};
                      } else {
                        if (StartsWith(src, "\n")) {
                          int tmp_strlen26066 = (strlen(src)) - (1) + 1;
                          char* tmp_str26066 = calloc(tmp_strlen26066, sizeof(char));
                          strncpy(tmp_str26066, src + 1, tmp_strlen26066 - 1);
                          tmp_str26066[tmp_strlen26066 - 1] = 0;
                          return (Next_results){tmp_str26066, TOK_NEWLINE, "\n"};
                        } else {
                          if (StartsWith(src, "(")) {
                            int tmp_strlen25987 = (strlen(src)) - (1) + 1;
                            char* tmp_str25987 = calloc(tmp_strlen25987, sizeof(char));
                            strncpy(tmp_str25987, src + 1, tmp_strlen25987 - 1);
                            tmp_str25987[tmp_strlen25987 - 1] = 0;
                            return (Next_results){tmp_str25987, TOK_LPAREN, "("};
                          } else {
                            if (StartsWith(src, ")")) {
                              int tmp_strlen25910 = (strlen(src)) - (1) + 1;
                              char* tmp_str25910 = calloc(tmp_strlen25910, sizeof(char));
                              strncpy(tmp_str25910, src + 1, tmp_strlen25910 - 1);
                              tmp_str25910[tmp_strlen25910 - 1] = 0;
                              return (Next_results){tmp_str25910, TOK_RPAREN, ")"};
                            } else {
                              if (StartsWith(src, "[")) {
                                int tmp_strlen25833 = (strlen(src)) - (1) + 1;
                                char* tmp_str25833 = calloc(tmp_strlen25833, sizeof(char));
                                strncpy(tmp_str25833, src + 1, tmp_strlen25833 - 1);
                                tmp_str25833[tmp_strlen25833 - 1] = 0;
                                return (Next_results){tmp_str25833, TOK_LBRACKET, "["};
                              } else {
                                if (StartsWith(src, "]")) {
                                  int tmp_strlen25754 = (strlen(src)) - (1) + 1;
                                  char* tmp_str25754 = calloc(tmp_strlen25754, sizeof(char));
                                  strncpy(tmp_str25754, src + 1, tmp_strlen25754 - 1);
                                  tmp_str25754[tmp_strlen25754 - 1] = 0;
                                  return (Next_results){tmp_str25754, TOK_RBRACKET, "]"};
                                } else {
                                  if (StartsWith(src, "{")) {
                                    int tmp_strlen25675 = (strlen(src)) - (1) + 1;
                                    char* tmp_str25675 = calloc(tmp_strlen25675, sizeof(char));
                                    strncpy(tmp_str25675, src + 1, tmp_strlen25675 - 1);
                                    tmp_str25675[tmp_strlen25675 - 1] = 0;
                                    return (Next_results){tmp_str25675, TOK_LCURLY, "{"};
                                  } else {
                                    if (StartsWith(src, "}")) {
                                      ...
                                      return (Next_results){tmp_str25598, TOK_RCURLY, "}"};
                                    } else {
                                      if (StartsWith(src, ":")) {
                                        ...
                                        return (Next_results){tmp_str25521, TOK_COLON, ":"};
                                      } else {
                                        if (StartsWith(src, ",")) {
                                          int tmp_strlen25445 = (strlen(src)) - (1) + 1;
                                          char* tmp_str25445 = calloc(tmp_strlen25445, sizeof(char));
                                          strncpy(tmp_str25445, src + 1, tmp_strlen25445 - 1);
                                          tmp_str25445[tmp_strlen25445 - 1] = 0;
                                          return (Next_results){tmp_str25445, TOK_COMMA, ","};
                                        } else {
                                          if (StartsWith(src, "=")) {
                                            int tmp_strlen25369 = (strlen(src)) - (1) + 1;
                                            char* tmp_str25369 = calloc(tmp_strlen25369, sizeof(char));
                                            strncpy(tmp_str25369, src + 1, tmp_strlen25369 - 1);
                                            tmp_str25369[tmp_strlen25369 - 1] = 0;
                                            return (Next_results){tmp_str25369, TOK_ASSIGN, "="};
                                          } else {
                                            if (StartsWith(src, "!")) {
                                              int tmp_strlen25292 = (strlen(src)) - (1) + 1;
                                              char* tmp_str25292 = calloc(tmp_strlen25292, sizeof(char));
                                              strncpy(tmp_str25292, src + 1, tmp_strlen25292 - 1);
                                              tmp_str25292[tmp_strlen25292 - 1] = 0;
                                              return (Next_results){tmp_str25292, TOK_BNOT, "!"};
                                            } else {
                                              if (StartsWith(src, "+")) {
                                                int tmp_strlen25217 = (strlen(src)) - (1) + 1;
                                                char* tmp_str25217 = calloc(tmp_strlen25217, sizeof(char));
                                                strncpy(tmp_str25217, src + 1, tmp_strlen25217 - 1);
                                                tmp_str25217[tmp_strlen25217 - 1] = 0;
                                                return (Next_results){tmp_str25217, TOK_ADD, "+"};
                                              } else {
                                                if (StartsWith(src, "-")) {
                                                  int tmp_strlen25143 = (strlen(src)) - (1) + 1;
                                                  char* tmp_str25143 = calloc(tmp_strlen25143, sizeof(char));
                                                  strncpy(tmp_str25143, src + 1, tmp_strlen25143 - 1);
                                                  tmp_str25143[tmp_strlen25143 - 1] = 0;
                                                  return (Next_results){tmp_str25143, TOK_SUB, "-"};
                                                } else {
                                                  if (StartsWith(src, "*")) {
                                                    int tmp_strlen25069 = (strlen(src)) - (1) + 1;
                                                    char* tmp_str25069 = calloc(tmp_strlen25069, sizeof(char));
                                                    strncpy(tmp_str25069, src + 1, tmp_strlen25069 - 1);
                                                    tmp_str25069[tmp_strlen25069 - 1] = 0;
                                                    return (Next_results){tmp_str25069, TOK_MUL, "*"};
                                                  } else {
                                                    if (StartsWith(src, "/")) {
                                                      int tmp_strlen24995 = (strlen(src)) - (1) + 1;
                                                      char* tmp_str24995 = calloc(tmp_strlen24995, sizeof(char));
                                                      strncpy(tmp_str24995, src + 1, tmp_strlen24995 - 1);
                                                      tmp_str24995[tmp_strlen24995 - 1] = 0;
                                                      return (Next_results){tmp_str24995, TOK_DIV, "/"};
                                                    } else {
                                                      if (StartsWith(src, "%")) {
                                                        int tmp_strlen24921 = (strlen(src)) - (1) + 1;
                                                        char* tmp_str24921 = calloc(tmp_strlen24921, sizeof(char));
                                                        strncpy(tmp_str24921, src + 1, tmp_strlen24921 - 1);
                                                        tmp_str24921[tmp_strlen24921 - 1] = 0;
                                                        return (Next_results){tmp_str24921, TOK_REM, "%"};
                                                      } else {
                                                        if (StartsWith(src, "~")) {
                                                          int tmp_strlen24847 = (strlen(src)) - (1) + 1;
                                                          char* tmp_str24847 = calloc(tmp_strlen24847, sizeof(char));
                                                          strncpy(tmp_str24847, src + 1, tmp_strlen24847 - 1);
                                                          tmp_str24847[tmp_strlen24847 - 1] = 0;
                                                          return (Next_results){tmp_str24847, TOK_INOT, "~"};
                                                        } else {
                                                          if (StartsWith(src, "|")) {
                                                            int tmp_strlen24772 = (strlen(src)) - (1) + 1;
                                                            char* tmp_str24772 = calloc(tmp_strlen24772, sizeof(char));
                                                            strncpy(tmp_str24772, src + 1, tmp_strlen24772 - 1);
                                                            tmp_str24772[tmp_strlen24772 - 1] = 0;
                                                            return (Next_results){tmp_str24772, TOK_IOR, "|"};
                                                          } else {
                                                            if (StartsWith(src, "&")) {
                                                              int tmp_strlen24698 = (strlen(src)) - (1) + 1;
                                                              char* tmp_str24698 = calloc(tmp_strlen24698, sizeof(char));
                                                              strncpy(tmp_str24698, src + 1, tmp_strlen24698 - 1);
                                                              tmp_str24698[tmp_strlen24698 - 1] = 0;
                                                              return (Next_results){tmp_str24698, TOK_IAND, "&"};
                                                            } else {
                                                              if (StartsWith(src, "^")) {
                                                                int tmp_strlen24623 = (strlen(src)) - (1) + 1;
                                                                char* tmp_str24623 = calloc(tmp_strlen24623, sizeof(char));
                                                                strncpy(tmp_str24623, src + 1, tmp_strlen24623 - 1);
                                                                tmp_str24623[tmp_strlen24623 - 1] = 0;
                                                                return (Next_results){tmp_str24623, TOK_IXOR, "^"};
                                                              } else {
                                                                if (StartsWith(src, "<")) {
                                                                  int tmp_strlen24548 = (strlen(src)) - (1) + 1;
                                                                  char* tmp_str24548 = calloc(tmp_strlen24548, sizeof(char));
                                                                  strncpy(tmp_str24548, src + 1, tmp_strlen24548 - 1);
                                                                  tmp_str24548[tmp_strlen24548 - 1] = 0;
                                                                  return (Next_results){tmp_str24548, TOK_LESS, "<"};
                                                                } else {
                                                                  if (StartsWith(src, ">")) {
                                                                    int tmp_strlen24473 = (strlen(src)) - (1) + 1;
                                                                    char* tmp_str24473 = calloc(tmp_strlen24473, sizeof(char));
                                                                    strncpy(tmp_str24473, src + 1, tmp_strlen24473 - 1);
                                                                    tmp_str24473[tmp_strlen24473 - 1] = 0;
                                                                    return (Next_results){tmp_str24473, TOK_GREATER, ">"};
                                                                  } else {
                                                                    if (IsAlpha(src[0])) {
                                                                      int i = 1;
                                                                      ...
                                                                      i = (i) - (1);
                                                                      int tmp_strlen24243 = (i) - (0) + 1;
                                                                      char* tmp_str24243 = calloc(tmp_strlen24243, sizeof(char));
                                                                      strncpy(tmp_str24243, src + 0, tmp_strlen24243 - 1);
                                                                      tmp_str24243[tmp_strlen24243 - 1] = 0;
                                                                      char* ts = tmp_str24243;
                                                                      int tt;
                                                                      if ((strcmp(ts, "fn") == 0)) {
                                                                        tt = TOK_FN;
                                                                      } else {
                                                                      ...
                                                                      int tmp_strlen23450 = (strlen(src)) - (i) + 1;
                                                                      char* tmp_str23450 = calloc(tmp_strlen23450, sizeof(char));
                                                                      strncpy(tmp_str23450, src + i, tmp_strlen23450 - 1);
                                                                      tmp_str23450[tmp_strlen23450 - 1] = 0;
                                                                      return (Next_results){tmp_str23450, tt, ts};
                                                                    } else {
                                                                      if (IsNumeric(src[0])) {
                                                                        int i = 1;
                                                                        ...
                                                                        int tmp_strlen23282 = (strlen(src)) - (i) + 1;
                                                                        char* tmp_str23282 = calloc(tmp_strlen23282, sizeof(char));
                                                                        strncpy(tmp_str23282, src + i, tmp_strlen23282 - 1);
                                                                        tmp_str23282[tmp_strlen23282 - 1] = 0;
                                                                        int tmp_strlen23262 = (i) - (0) + 1;
                                                                        char* tmp_str23262 = calloc(tmp_strlen23262, sizeof(char));
                                                                        strncpy(tmp_str23262, src + 0, tmp_strlen23262 - 1);
                                                                        tmp_str23262[tmp_strlen23262 - 1] = 0;
                                                                        return (Next_results){tmp_str23282, TOK_INTLIT, tmp_str23262};
                                                                      } else {
                                                                        if (StartsWith(src, "\"")) {
                                                                          int i = 1;
                                                                          while (true) {
                                                                            int tmp_strlen23180 = ((i) + (1)) - (i) + 1;
                                                                            char* tmp_str23180 = calloc(tmp_strlen23180, sizeof(char));
                                                                            strncpy(tmp_str23180, src + i, tmp_strlen23180 - 1);
                                                                            tmp_str23180[tmp_strlen23180 - 1] = 0;
                                                                            if (!((strcmp(tmp_str23180, "\"") != 0))) break;
                                                                            i = (i) + (1);
                                                                            int tmp_strlen23119 = (i) - ((i) - (1)) + 1;
                                                                            char* tmp_str23119 = calloc(tmp_strlen23119, sizeof(char));
                                                                            strncpy(tmp_str23119, src + (i) - (1), tmp_strlen23119 - 1);
                                                                            tmp_str23119[tmp_strlen23119 - 1] = 0;
                                                                            if ((strcmp(tmp_str23119, "\\") == 0)) {
                                                                              i = (i) + (1);
                                                                            }
                                                                          }
                                                                          i = (i) + (1);
                                                                          int tmp_strlen23017 = (strlen(src)) - (i) + 1;
                                                                          char* tmp_str23017 = calloc(tmp_strlen23017, sizeof(char));
                                                                          strncpy(tmp_str23017, src + i, tmp_strlen23017 - 1);
                                                                          tmp_str23017[tmp_strlen23017 - 1] = 0;
                                                                          int tmp_strlen22997 = (i) - (0) + 1;
                                                                          char* tmp_str22997 = calloc(tmp_strlen22997, sizeof(char));
                                                                          strncpy(tmp_str22997, src + 0, tmp_strlen22997 - 1);
                                                                          tmp_str22997[tmp_strlen22997 - 1] = 0;
                                                                          return (Next_results){tmp_str23017, TOK_STRLIT, tmp_str22997};
                                                                        } else {
                                                                          int tmp_strlen22932 = (1) - (0) + 1;
                                                                          char* tmp_str22932 = calloc(tmp_strlen22932, sizeof(char));
                                                                          strncpy(tmp_str22932, src + 0, tmp_strlen22932 - 1);
                                                                          tmp_str22932[tmp_strlen22932 - 1] = 0;
                                                                          int tmp_strlen22929 = strlen("unexpected token start: ") + strlen(tmp_str22932) + 1;
                                                                          char* tmp_str22929 = calloc(tmp_strlen22929, sizeof(char));
                                                                          strcpy(tmp_str22929, "unexpected token start: ");
                                                                          strcat(tmp_str22929, tmp_str22932);
...
TranslateAssignStmt_results TranslateAssignStmt(char* src, char* indent) {
  int x = Find(src, "=");
  int tmp_strlen11946 = (x) - (0) + 1;
  char* tmp_str11946 = calloc(tmp_strlen11946, sizeof(char));
  strncpy(tmp_str11946, src + 0, tmp_strlen11946 - 1);
  tmp_str11946[tmp_strlen11946 - 1] = 0;
  char* lhs = tmp_str11946;
  int tmp_strlen11913 = (strlen(src)) - ((x) + (1)) + 1;
  char* tmp_str11913 = calloc(tmp_strlen11913, sizeof(char));
  strncpy(tmp_str11913, src + (x) + (1), tmp_strlen11913 - 1);
  tmp_str11913[tmp_strlen11913 - 1] = 0;
  char* rhs = tmp_str11913;
  char* lhs_ident;
