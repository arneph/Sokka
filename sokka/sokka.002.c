...
int Find(char* haystack, char* needle) {
  ...
  while ((i) <= ((strlen(haystack)) - (strlen(needle)))) {
    if ((haystack[i]) != (c)) {
      ...
      int tmp_strlen28445 = ((i) + (strlen(needle))) - (i) + 1;
      char* tmp_str28445 = calloc(tmp_strlen28445, sizeof(char));
      strncpy(tmp_str28445, haystack + i, tmp_strlen28445 - 1);
      tmp_str28445[tmp_strlen28445 - 1] = 0;
      if ((strcmp(tmp_str28445, needle) != 0)) {
        i = (i) + (1);
        continue;
      }
    }
...
bool StartsWith(char* text, char* prefix) {
  if ((strlen(text)) < (strlen(prefix))) {
    ...
    if ((strlen(text)) == (strlen(prefix))) {
      ...
      int tmp_strlen28110 = (strlen(prefix)) - (0) + 1;
      char* tmp_str28110 = calloc(tmp_strlen28110, sizeof(char));
      strncpy(tmp_str28110, text + 0, tmp_strlen28110 - 1);
      tmp_str28110[tmp_strlen28110 - 1] = 0;
      return (strcmp(tmp_str28110, prefix) == 0);
    }
  }
}
...
char* RemoveLeadingWhitespace(char* text) {
  while ((StartsWith(text, " ")) || (StartsWith(text, "\t"))) {
    int tmp_strlen27716 = (strlen(text)) - (1) + 1;
    char* tmp_str27716 = calloc(tmp_strlen27716, sizeof(char));
    strncpy(tmp_str27716, text + 1, tmp_strlen27716 - 1);
    tmp_str27716[tmp_strlen27716 - 1] = 0;
    text = tmp_str27716;
  }
  return text;
}
...
Next_results Next(char* src) {
  ...
  if ((strcmp(src, "") == 0)) {
    ...
    if (StartsWith(src, "->")) {
      int tmp_strlen27493 = (strlen(src)) - (2) + 1;
      char* tmp_str27493 = calloc(tmp_strlen27493, sizeof(char));
      strncpy(tmp_str27493, src + 2, tmp_strlen27493 - 1);
      tmp_str27493[tmp_strlen27493 - 1] = 0;
      return (Next_results){tmp_str27493, TOK_RARROW, "->"};
    } else {
      if (StartsWith(src, "||")) {
        int tmp_strlen27414 = (strlen(src)) - (2) + 1;
        char* tmp_str27414 = calloc(tmp_strlen27414, sizeof(char));
        strncpy(tmp_str27414, src + 2, tmp_strlen27414 - 1);
        tmp_str27414[tmp_strlen27414 - 1] = 0;
        return (Next_results){tmp_str27414, TOK_BOR, "||"};
      } else {
        if (StartsWith(src, "&&")) {
          int tmp_strlen27338 = (strlen(src)) - (2) + 1;
          char* tmp_str27338 = calloc(tmp_strlen27338, sizeof(char));
          strncpy(tmp_str27338, src + 2, tmp_strlen27338 - 1);
          tmp_str27338[tmp_strlen27338 - 1] = 0;
          return (Next_results){tmp_str27338, TOK_BAND, "&&"};
        } else {
          if (StartsWith(src, "==")) {
            int tmp_strlen27261 = (strlen(src)) - (2) + 1;
            char* tmp_str27261 = calloc(tmp_strlen27261, sizeof(char));
            strncpy(tmp_str27261, src + 2, tmp_strlen27261 - 1);
            tmp_str27261[tmp_strlen27261 - 1] = 0;
            return (Next_results){tmp_str27261, TOK_EQ, "=="};
          } else {
            if (StartsWith(src, "!=")) {
              int tmp_strlen27186 = (strlen(src)) - (2) + 1;
              char* tmp_str27186 = calloc(tmp_strlen27186, sizeof(char));
              strncpy(tmp_str27186, src + 2, tmp_strlen27186 - 1);
              tmp_str27186[tmp_strlen27186 - 1] = 0;
              return (Next_results){tmp_str27186, TOK_NEQ, "!="};
            } else {
              if (StartsWith(src, "<=")) {
                int tmp_strlen27110 = (strlen(src)) - (2) + 1;
                char* tmp_str27110 = calloc(tmp_strlen27110, sizeof(char));
                strncpy(tmp_str27110, src + 2, tmp_strlen27110 - 1);
                tmp_str27110[tmp_strlen27110 - 1] = 0;
                return (Next_results){tmp_str27110, TOK_LEQ, "<="};
              } else {
                if (StartsWith(src, ">=")) {
                  int tmp_strlen27034 = (strlen(src)) - (2) + 1;
                  char* tmp_str27034 = calloc(tmp_strlen27034, sizeof(char));
                  strncpy(tmp_str27034, src + 2, tmp_strlen27034 - 1);
                  tmp_str27034[tmp_strlen27034 - 1] = 0;
                  return (Next_results){tmp_str27034, TOK_GEQ, ">="};
                } else {
                  if (StartsWith(src, "++")) {
                    int tmp_strlen26958 = (strlen(src)) - (2) + 1;
                    char* tmp_str26958 = calloc(tmp_strlen26958, sizeof(char));
                    strncpy(tmp_str26958, src + 2, tmp_strlen26958 - 1);
                    tmp_str26958[tmp_strlen26958 - 1] = 0;
                    return (Next_results){tmp_str26958, TOK_STRCAT, "++"};
                  } else {
                    if (StartsWith(src, "<>")) {
                      int tmp_strlen26879 = (strlen(src)) - (2) + 1;
                      char* tmp_str26879 = calloc(tmp_strlen26879, sizeof(char));
                      strncpy(tmp_str26879, src + 2, tmp_strlen26879 - 1);
                      tmp_str26879[tmp_strlen26879 - 1] = 0;
                      return (Next_results){tmp_str26879, TOK_STREQ, "<>"};
                    } else {
                      if (StartsWith(src, "<!>")) {
                        int tmp_strlen26800 = (strlen(src)) - (3) + 1;
                        char* tmp_str26800 = calloc(tmp_strlen26800, sizeof(char));
                        strncpy(tmp_str26800, src + 3, tmp_strlen26800 - 1);
                        tmp_str26800[tmp_strlen26800 - 1] = 0;
                        return (Next_results){tmp_str26800, TOK_STRNEQ, "<!>"};
                      } else {
                        if (StartsWith(src, "\n")) {
                          int tmp_strlen26720 = (strlen(src)) - (1) + 1;
                          char* tmp_str26720 = calloc(tmp_strlen26720, sizeof(char));
                          strncpy(tmp_str26720, src + 1, tmp_strlen26720 - 1);
                          tmp_str26720[tmp_strlen26720 - 1] = 0;
                          return (Next_results){tmp_str26720, TOK_NEWLINE, "\n"};
                        } else {
                          if (StartsWith(src, "(")) {
                            int tmp_strlen26641 = (strlen(src)) - (1) + 1;
                            char* tmp_str26641 = calloc(tmp_strlen26641, sizeof(char));
                            strncpy(tmp_str26641, src + 1, tmp_strlen26641 - 1);
                            tmp_str26641[tmp_strlen26641 - 1] = 0;
                            return (Next_results){tmp_str26641, TOK_LPAREN, "("};
                          } else {
                            if (StartsWith(src, ")")) {
                              int tmp_strlen26564 = (strlen(src)) - (1) + 1;
                              char* tmp_str26564 = calloc(tmp_strlen26564, sizeof(char));
                              strncpy(tmp_str26564, src + 1, tmp_strlen26564 - 1);
                              tmp_str26564[tmp_strlen26564 - 1] = 0;
                              return (Next_results){tmp_str26564, TOK_RPAREN, ")"};
                            } else {
                              if (StartsWith(src, "[")) {
                                int tmp_strlen26487 = (strlen(src)) - (1) + 1;
                                char* tmp_str26487 = calloc(tmp_strlen26487, sizeof(char));
                                strncpy(tmp_str26487, src + 1, tmp_strlen26487 - 1);
                                tmp_str26487[tmp_strlen26487 - 1] = 0;
                                return (Next_results){tmp_str26487, TOK_LBRACKET, "["};
                              } else {
                                if (StartsWith(src, "]")) {
                                  int tmp_strlen26408 = (strlen(src)) - (1) + 1;
                                  char* tmp_str26408 = calloc(tmp_strlen26408, sizeof(char));
                                  strncpy(tmp_str26408, src + 1, tmp_strlen26408 - 1);
                                  tmp_str26408[tmp_strlen26408 - 1] = 0;
                                  return (Next_results){tmp_str26408, TOK_RBRACKET, "]"};
                                } else {
                                  if (StartsWith(src, "{")) {
                                    int tmp_strlen26329 = (strlen(src)) - (1) + 1;
                                    char* tmp_str26329 = calloc(tmp_strlen26329, sizeof(char));
                                    strncpy(tmp_str26329, src + 1, tmp_strlen26329 - 1);
                                    tmp_str26329[tmp_strlen26329 - 1] = 0;
                                    return (Next_results){tmp_str26329, TOK_LCURLY, "{"};
                                  } else {
                                    if (StartsWith(src, "}")) {
                                      int tmp_strlen26252 = (strlen(src)) - (1) + 1;
                                      char* tmp_str26252 = calloc(tmp_strlen26252, sizeof(char));
                                      strncpy(tmp_str26252, src + 1, tmp_strlen26252 - 1);
                                      tmp_str26252[tmp_strlen26252 - 1] = 0;
                                      return (Next_results){tmp_str26252, TOK_RCURLY, "}"};
                                    } else {
                                      if (StartsWith(src, "_")) {
                                        int tmp_strlen26175 = (strlen(src)) - (1) + 1;
                                        char* tmp_str26175 = calloc(tmp_strlen26175, sizeof(char));
                                        strncpy(tmp_str26175, src + 1, tmp_strlen26175 - 1);
                                        tmp_str26175[tmp_strlen26175 - 1] = 0;
                                        return (Next_results){tmp_str26175, TOK_UNDERSCORE, "_"};
                                      } else {
                                        if (StartsWith(src, ":")) {
                                          int tmp_strlen26094 = (strlen(src)) - (1) + 1;
                                          char* tmp_str26094 = calloc(tmp_strlen26094, sizeof(char));
                                          strncpy(tmp_str26094, src + 1, tmp_strlen26094 - 1);
                                          tmp_str26094[tmp_strlen26094 - 1] = 0;
                                          return (Next_results){tmp_str26094, TOK_COLON, ":"};
                                        } else {
                                          if (StartsWith(src, ",")) {
                                            int tmp_strlen26018 = (strlen(src)) - (1) + 1;
                                            char* tmp_str26018 = calloc(tmp_strlen26018, sizeof(char));
                                            strncpy(tmp_str26018, src + 1, tmp_strlen26018 - 1);
                                            tmp_str26018[tmp_strlen26018 - 1] = 0;
                                            return (Next_results){tmp_str26018, TOK_COMMA, ","};
                                          } else {
                                            if (StartsWith(src, "=")) {
                                              int tmp_strlen25942 = (strlen(src)) - (1) + 1;
                                              char* tmp_str25942 = calloc(tmp_strlen25942, sizeof(char));
                                              strncpy(tmp_str25942, src + 1, tmp_strlen25942 - 1);
                                              tmp_str25942[tmp_strlen25942 - 1] = 0;
                                              return (Next_results){tmp_str25942, TOK_ASSIGN, "="};
                                            } else {
                                              if (StartsWith(src, "!")) {
                                                ...
                                                return (Next_results){tmp_str25865, TOK_BNOT, "!"};
                                              } else {
                                                if (StartsWith(src, "+")) {
                                                  ...
                                                  return (Next_results){tmp_str25790, TOK_ADD, "+"};
                                                } else {
                                                  if (StartsWith(src, "-")) {
                                                    int tmp_strlen25716 = (strlen(src)) - (1) + 1;
                                                    char* tmp_str25716 = calloc(tmp_strlen25716, sizeof(char));
                                                    strncpy(tmp_str25716, src + 1, tmp_strlen25716 - 1);
                                                    tmp_str25716[tmp_strlen25716 - 1] = 0;
                                                    return (Next_results){tmp_str25716, TOK_SUB, "-"};
                                                  } else {
                                                    if (StartsWith(src, "*")) {
                                                      int tmp_strlen25642 = (strlen(src)) - (1) + 1;
                                                      char* tmp_str25642 = calloc(tmp_strlen25642, sizeof(char));
                                                      strncpy(tmp_str25642, src + 1, tmp_strlen25642 - 1);
                                                      tmp_str25642[tmp_strlen25642 - 1] = 0;
                                                      return (Next_results){tmp_str25642, TOK_MUL, "*"};
                                                    } else {
                                                      if (StartsWith(src, "/")) {
                                                        int tmp_strlen25568 = (strlen(src)) - (1) + 1;
                                                        char* tmp_str25568 = calloc(tmp_strlen25568, sizeof(char));
                                                        strncpy(tmp_str25568, src + 1, tmp_strlen25568 - 1);
                                                        tmp_str25568[tmp_strlen25568 - 1] = 0;
                                                        return (Next_results){tmp_str25568, TOK_DIV, "/"};
                                                      } else {
                                                        if (StartsWith(src, "%")) {
                                                          int tmp_strlen25494 = (strlen(src)) - (1) + 1;
                                                          char* tmp_str25494 = calloc(tmp_strlen25494, sizeof(char));
                                                          strncpy(tmp_str25494, src + 1, tmp_strlen25494 - 1);
                                                          tmp_str25494[tmp_strlen25494 - 1] = 0;
                                                          return (Next_results){tmp_str25494, TOK_REM, "%"};
                                                        } else {
                                                          if (StartsWith(src, "~")) {
                                                            int tmp_strlen25420 = (strlen(src)) - (1) + 1;
                                                            char* tmp_str25420 = calloc(tmp_strlen25420, sizeof(char));
                                                            strncpy(tmp_str25420, src + 1, tmp_strlen25420 - 1);
                                                            tmp_str25420[tmp_strlen25420 - 1] = 0;
                                                            return (Next_results){tmp_str25420, TOK_INOT, "~"};
                                                          } else {
                                                            if (StartsWith(src, "|")) {
                                                              int tmp_strlen25345 = (strlen(src)) - (1) + 1;
                                                              char* tmp_str25345 = calloc(tmp_strlen25345, sizeof(char));
                                                              strncpy(tmp_str25345, src + 1, tmp_strlen25345 - 1);
                                                              tmp_str25345[tmp_strlen25345 - 1] = 0;
                                                              return (Next_results){tmp_str25345, TOK_IOR, "|"};
                                                            } else {
                                                              if (StartsWith(src, "&")) {
                                                                int tmp_strlen25271 = (strlen(src)) - (1) + 1;
                                                                char* tmp_str25271 = calloc(tmp_strlen25271, sizeof(char));
                                                                strncpy(tmp_str25271, src + 1, tmp_strlen25271 - 1);
                                                                tmp_str25271[tmp_strlen25271 - 1] = 0;
                                                                return (Next_results){tmp_str25271, TOK_IAND, "&"};
                                                              } else {
                                                                if (StartsWith(src, "^")) {
                                                                  int tmp_strlen25196 = (strlen(src)) - (1) + 1;
                                                                  char* tmp_str25196 = calloc(tmp_strlen25196, sizeof(char));
                                                                  strncpy(tmp_str25196, src + 1, tmp_strlen25196 - 1);
                                                                  tmp_str25196[tmp_strlen25196 - 1] = 0;
                                                                  return (Next_results){tmp_str25196, TOK_IXOR, "^"};
                                                                } else {
                                                                  if (StartsWith(src, "<")) {
                                                                    int tmp_strlen25121 = (strlen(src)) - (1) + 1;
                                                                    char* tmp_str25121 = calloc(tmp_strlen25121, sizeof(char));
                                                                    strncpy(tmp_str25121, src + 1, tmp_strlen25121 - 1);
                                                                    tmp_str25121[tmp_strlen25121 - 1] = 0;
                                                                    return (Next_results){tmp_str25121, TOK_LESS, "<"};
                                                                  } else {
                                                                    if (StartsWith(src, ">")) {
                                                                      int tmp_strlen25046 = (strlen(src)) - (1) + 1;
                                                                      char* tmp_str25046 = calloc(tmp_strlen25046, sizeof(char));
                                                                      strncpy(tmp_str25046, src + 1, tmp_strlen25046 - 1);
                                                                      tmp_str25046[tmp_strlen25046 - 1] = 0;
                                                                      return (Next_results){tmp_str25046, TOK_GREATER, ">"};
                                                                    } else {
                                                                      if (IsAlpha(src[0])) {
                                                                        int i = 1;
                                                                        ...
                                                                        i = (i) - (1);
                                                                        int tmp_strlen24815 = (i) - (0) + 1;
                                                                        char* tmp_str24815 = calloc(tmp_strlen24815, sizeof(char));
                                                                        strncpy(tmp_str24815, src + 0, tmp_strlen24815 - 1);
                                                                        tmp_str24815[tmp_strlen24815 - 1] = 0;
                                                                        char* ts = tmp_str24815;
                                                                        int tt;
                                                                        if ((strcmp(ts, "fn") == 0)) {
                                                                          tt = TOK_FN;
                                                                        } else {
                                                                        ...
                                                                        int tmp_strlen24023 = (strlen(src)) - (i) + 1;
                                                                        char* tmp_str24023 = calloc(tmp_strlen24023, sizeof(char));
                                                                        strncpy(tmp_str24023, src + i, tmp_strlen24023 - 1);
                                                                        tmp_str24023[tmp_strlen24023 - 1] = 0;
                                                                        return (Next_results){tmp_str24023, tt, ts};
                                                                      } else {
                                                                        if (IsNumeric(src[0])) {
                                                                          int i = 1;
                                                                          ...
                                                                          int tmp_strlen23855 = (strlen(src)) - (i) + 1;
                                                                          char* tmp_str23855 = calloc(tmp_strlen23855, sizeof(char));
                                                                          strncpy(tmp_str23855, src + i, tmp_strlen23855 - 1);
                                                                          tmp_str23855[tmp_strlen23855 - 1] = 0;
                                                                          int tmp_strlen23834 = (i) - (0) + 1;
                                                                          char* tmp_str23834 = calloc(tmp_strlen23834, sizeof(char));
                                                                          strncpy(tmp_str23834, src + 0, tmp_strlen23834 - 1);
                                                                          tmp_str23834[tmp_strlen23834 - 1] = 0;
                                                                          return (Next_results){tmp_str23855, TOK_INTLIT, tmp_str23834};
                                                                        } else {
                                                                          if (StartsWith(src, "\"")) {
                                                                            int i = 1;
                                                                            while (true) {
                                                                              int tmp_strlen23753 = ((i) + (1)) - (i) + 1;
                                                                              char* tmp_str23753 = calloc(tmp_strlen23753, sizeof(char));
                                                                              strncpy(tmp_str23753, src + i, tmp_strlen23753 - 1);
                                                                              tmp_str23753[tmp_strlen23753 - 1] = 0;
                                                                              if (!((strcmp(tmp_str23753, "\"") != 0))) break;
                                                                              i = (i) + (1);
                                                                              int tmp_strlen23694 = (i) - ((i) - (1)) + 1;
                                                                              char* tmp_str23694 = calloc(tmp_strlen23694, sizeof(char));
                                                                              strncpy(tmp_str23694, src + (i) - (1), tmp_strlen23694 - 1);
                                                                              tmp_str23694[tmp_strlen23694 - 1] = 0;
                                                                              if ((strcmp(tmp_str23694, "\\") == 0)) {
                                                                                i = (i) + (1);
                                                                              }
                                                                            }
                                                                            i = (i) + (1);
                                                                            int tmp_strlen23590 = (strlen(src)) - (i) + 1;
                                                                            char* tmp_str23590 = calloc(tmp_strlen23590, sizeof(char));
                                                                            strncpy(tmp_str23590, src + i, tmp_strlen23590 - 1);
                                                                            tmp_str23590[tmp_strlen23590 - 1] = 0;
                                                                            int tmp_strlen23569 = (i) - (0) + 1;
                                                                            char* tmp_str23569 = calloc(tmp_strlen23569, sizeof(char));
                                                                            strncpy(tmp_str23569, src + 0, tmp_strlen23569 - 1);
                                                                            tmp_str23569[tmp_strlen23569 - 1] = 0;
                                                                            return (Next_results){tmp_str23590, TOK_STRLIT, tmp_str23569};
                                                                          } else {
                                                                            int tmp_strlen23504 = (1) - (0) + 1;
                                                                            char* tmp_str23504 = calloc(tmp_strlen23504, sizeof(char));
                                                                            strncpy(tmp_str23504, src + 0, tmp_strlen23504 - 1);
                                                                            tmp_str23504[tmp_strlen23504 - 1] = 0;
                                                                            int tmp_strlen23500 = strlen("unexpected token start: ") + strlen(tmp_str23504) + 1;
                                                                            char* tmp_str23500 = calloc(tmp_strlen23500, sizeof(char));
                                                                            strcpy(tmp_str23500, "unexpected token start: ");
                                                                            strcat(tmp_str23500, tmp_str23504);
