...
int Find(char* haystack, char* needle) {
  ...
  while ((i) <= ((strlen(haystack)) - (strlen(needle)))) {
    if ((haystack[i]) != (c)) {
      ...
      int tmp_strlen29031 = ((i) + (strlen(needle))) - (i) + 1;
      char* tmp_str29031 = calloc(tmp_strlen29031, sizeof(char));
      strncpy(tmp_str29031, haystack + i, tmp_strlen29031 - 1);
      tmp_str29031[tmp_strlen29031 - 1] = 0;
      if ((strcmp(tmp_str29031, needle) != 0)) {
        i = (i) + (1);
        continue;
      }
    }
...
bool StartsWith(char* text, char* prefix) {
  if ((strlen(text)) < (strlen(prefix))) {
    ...
    if ((strlen(text)) == (strlen(prefix))) {
      ...
      int tmp_strlen28697 = (strlen(prefix)) - (0) + 1;
      char* tmp_str28697 = calloc(tmp_strlen28697, sizeof(char));
      strncpy(tmp_str28697, text + 0, tmp_strlen28697 - 1);
      tmp_str28697[tmp_strlen28697 - 1] = 0;
      return (strcmp(tmp_str28697, prefix) == 0);
    }
  }
}
...
char* RemoveLeadingWhitespace(char* text) {
  while ((StartsWith(text, " ")) || (StartsWith(text, "\t"))) {
    int tmp_strlen28302 = (strlen(text)) - (1) + 1;
    char* tmp_str28302 = calloc(tmp_strlen28302, sizeof(char));
    strncpy(tmp_str28302, text + 1, tmp_strlen28302 - 1);
    tmp_str28302[tmp_strlen28302 - 1] = 0;
    text = tmp_str28302;
  }
  return text;
}
...
Next_results Next(char* src) {
  ...
  if ((strcmp(src, "") == 0)) {
    ...
    if (StartsWith(src, "->")) {
      int tmp_strlen28079 = (strlen(src)) - (2) + 1;
      char* tmp_str28079 = calloc(tmp_strlen28079, sizeof(char));
      strncpy(tmp_str28079, src + 2, tmp_strlen28079 - 1);
      tmp_str28079[tmp_strlen28079 - 1] = 0;
      return (Next_results){tmp_str28079, TOK_RARROW, "->"};
    } else {
      if (StartsWith(src, "||")) {
        int tmp_strlen28000 = (strlen(src)) - (2) + 1;
        char* tmp_str28000 = calloc(tmp_strlen28000, sizeof(char));
        strncpy(tmp_str28000, src + 2, tmp_strlen28000 - 1);
        tmp_str28000[tmp_strlen28000 - 1] = 0;
        return (Next_results){tmp_str28000, TOK_BOR, "||"};
      } else {
        if (StartsWith(src, "&&")) {
          int tmp_strlen27924 = (strlen(src)) - (2) + 1;
          char* tmp_str27924 = calloc(tmp_strlen27924, sizeof(char));
          strncpy(tmp_str27924, src + 2, tmp_strlen27924 - 1);
          tmp_str27924[tmp_strlen27924 - 1] = 0;
          return (Next_results){tmp_str27924, TOK_BAND, "&&"};
        } else {
          if (StartsWith(src, "==")) {
            int tmp_strlen27847 = (strlen(src)) - (2) + 1;
            char* tmp_str27847 = calloc(tmp_strlen27847, sizeof(char));
            strncpy(tmp_str27847, src + 2, tmp_strlen27847 - 1);
            tmp_str27847[tmp_strlen27847 - 1] = 0;
            return (Next_results){tmp_str27847, TOK_EQ, "=="};
          } else {
            if (StartsWith(src, "!=")) {
              int tmp_strlen27772 = (strlen(src)) - (2) + 1;
              char* tmp_str27772 = calloc(tmp_strlen27772, sizeof(char));
              strncpy(tmp_str27772, src + 2, tmp_strlen27772 - 1);
              tmp_str27772[tmp_strlen27772 - 1] = 0;
              return (Next_results){tmp_str27772, TOK_NEQ, "!="};
            } else {
              if (StartsWith(src, "<=")) {
                int tmp_strlen27696 = (strlen(src)) - (2) + 1;
                char* tmp_str27696 = calloc(tmp_strlen27696, sizeof(char));
                strncpy(tmp_str27696, src + 2, tmp_strlen27696 - 1);
                tmp_str27696[tmp_strlen27696 - 1] = 0;
                return (Next_results){tmp_str27696, TOK_LEQ, "<="};
              } else {
                if (StartsWith(src, ">=")) {
                  int tmp_strlen27620 = (strlen(src)) - (2) + 1;
                  char* tmp_str27620 = calloc(tmp_strlen27620, sizeof(char));
                  strncpy(tmp_str27620, src + 2, tmp_strlen27620 - 1);
                  tmp_str27620[tmp_strlen27620 - 1] = 0;
                  return (Next_results){tmp_str27620, TOK_GEQ, ">="};
                } else {
                  if (StartsWith(src, "++")) {
                    int tmp_strlen27544 = (strlen(src)) - (2) + 1;
                    char* tmp_str27544 = calloc(tmp_strlen27544, sizeof(char));
                    strncpy(tmp_str27544, src + 2, tmp_strlen27544 - 1);
                    tmp_str27544[tmp_strlen27544 - 1] = 0;
                    return (Next_results){tmp_str27544, TOK_STRCAT, "++"};
                  } else {
                    if (StartsWith(src, "<>")) {
                      int tmp_strlen27465 = (strlen(src)) - (2) + 1;
                      char* tmp_str27465 = calloc(tmp_strlen27465, sizeof(char));
                      strncpy(tmp_str27465, src + 2, tmp_strlen27465 - 1);
                      tmp_str27465[tmp_strlen27465 - 1] = 0;
                      return (Next_results){tmp_str27465, TOK_STREQ, "<>"};
                    } else {
                      if (StartsWith(src, "<!>")) {
                        int tmp_strlen27386 = (strlen(src)) - (3) + 1;
                        char* tmp_str27386 = calloc(tmp_strlen27386, sizeof(char));
                        strncpy(tmp_str27386, src + 3, tmp_strlen27386 - 1);
                        tmp_str27386[tmp_strlen27386 - 1] = 0;
                        return (Next_results){tmp_str27386, TOK_STRNEQ, "<!>"};
                      } else {
                        if (StartsWith(src, "\n")) {
                          int tmp_strlen27306 = (strlen(src)) - (1) + 1;
                          char* tmp_str27306 = calloc(tmp_strlen27306, sizeof(char));
                          strncpy(tmp_str27306, src + 1, tmp_strlen27306 - 1);
                          tmp_str27306[tmp_strlen27306 - 1] = 0;
                          return (Next_results){tmp_str27306, TOK_NEWLINE, "\n"};
                        } else {
                          if (StartsWith(src, "(")) {
                            int tmp_strlen27227 = (strlen(src)) - (1) + 1;
                            char* tmp_str27227 = calloc(tmp_strlen27227, sizeof(char));
                            strncpy(tmp_str27227, src + 1, tmp_strlen27227 - 1);
                            tmp_str27227[tmp_strlen27227 - 1] = 0;
                            return (Next_results){tmp_str27227, TOK_LPAREN, "("};
                          } else {
                            if (StartsWith(src, ")")) {
                              int tmp_strlen27150 = (strlen(src)) - (1) + 1;
                              char* tmp_str27150 = calloc(tmp_strlen27150, sizeof(char));
                              strncpy(tmp_str27150, src + 1, tmp_strlen27150 - 1);
                              tmp_str27150[tmp_strlen27150 - 1] = 0;
                              return (Next_results){tmp_str27150, TOK_RPAREN, ")"};
                            } else {
                              if (StartsWith(src, "[")) {
                                int tmp_strlen27073 = (strlen(src)) - (1) + 1;
                                char* tmp_str27073 = calloc(tmp_strlen27073, sizeof(char));
                                strncpy(tmp_str27073, src + 1, tmp_strlen27073 - 1);
                                tmp_str27073[tmp_strlen27073 - 1] = 0;
                                return (Next_results){tmp_str27073, TOK_LBRACKET, "["};
                              } else {
                                if (StartsWith(src, "]")) {
                                  int tmp_strlen26994 = (strlen(src)) - (1) + 1;
                                  char* tmp_str26994 = calloc(tmp_strlen26994, sizeof(char));
                                  strncpy(tmp_str26994, src + 1, tmp_strlen26994 - 1);
                                  tmp_str26994[tmp_strlen26994 - 1] = 0;
                                  return (Next_results){tmp_str26994, TOK_RBRACKET, "]"};
                                } else {
                                  if (StartsWith(src, "{")) {
                                    int tmp_strlen26915 = (strlen(src)) - (1) + 1;
                                    char* tmp_str26915 = calloc(tmp_strlen26915, sizeof(char));
                                    strncpy(tmp_str26915, src + 1, tmp_strlen26915 - 1);
                                    tmp_str26915[tmp_strlen26915 - 1] = 0;
                                    return (Next_results){tmp_str26915, TOK_LCURLY, "{"};
                                  } else {
                                    if (StartsWith(src, "}")) {
                                      int tmp_strlen26838 = (strlen(src)) - (1) + 1;
                                      char* tmp_str26838 = calloc(tmp_strlen26838, sizeof(char));
                                      strncpy(tmp_str26838, src + 1, tmp_strlen26838 - 1);
                                      tmp_str26838[tmp_strlen26838 - 1] = 0;
                                      return (Next_results){tmp_str26838, TOK_RCURLY, "}"};
                                    } else {
                                      if (StartsWith(src, ":")) {
                                        int tmp_strlen26761 = (strlen(src)) - (1) + 1;
                                        char* tmp_str26761 = calloc(tmp_strlen26761, sizeof(char));
                                        strncpy(tmp_str26761, src + 1, tmp_strlen26761 - 1);
                                        tmp_str26761[tmp_strlen26761 - 1] = 0;
                                        return (Next_results){tmp_str26761, TOK_COLON, ":"};
                                      } else {
                                        if (StartsWith(src, ",")) {
                                          int tmp_strlen26685 = (strlen(src)) - (1) + 1;
                                          char* tmp_str26685 = calloc(tmp_strlen26685, sizeof(char));
                                          strncpy(tmp_str26685, src + 1, tmp_strlen26685 - 1);
                                          tmp_str26685[tmp_strlen26685 - 1] = 0;
                                          return (Next_results){tmp_str26685, TOK_COMMA, ","};
                                        } else {
                                          if (StartsWith(src, "=")) {
                                            int tmp_strlen26609 = (strlen(src)) - (1) + 1;
                                            char* tmp_str26609 = calloc(tmp_strlen26609, sizeof(char));
                                            strncpy(tmp_str26609, src + 1, tmp_strlen26609 - 1);
                                            tmp_str26609[tmp_strlen26609 - 1] = 0;
                                            return (Next_results){tmp_str26609, TOK_ASSIGN, "="};
                                          } else {
                                            if (StartsWith(src, "!")) {
                                              int tmp_strlen26532 = (strlen(src)) - (1) + 1;
                                              char* tmp_str26532 = calloc(tmp_strlen26532, sizeof(char));
                                              strncpy(tmp_str26532, src + 1, tmp_strlen26532 - 1);
                                              tmp_str26532[tmp_strlen26532 - 1] = 0;
                                              return (Next_results){tmp_str26532, TOK_BNOT, "!"};
                                            } else {
                                              if (StartsWith(src, "+")) {
                                                int tmp_strlen26457 = (strlen(src)) - (1) + 1;
                                                char* tmp_str26457 = calloc(tmp_strlen26457, sizeof(char));
                                                strncpy(tmp_str26457, src + 1, tmp_strlen26457 - 1);
                                                tmp_str26457[tmp_strlen26457 - 1] = 0;
                                                return (Next_results){tmp_str26457, TOK_ADD, "+"};
                                              } else {
                                                if (StartsWith(src, "-")) {
                                                  int tmp_strlen26383 = (strlen(src)) - (1) + 1;
                                                  char* tmp_str26383 = calloc(tmp_strlen26383, sizeof(char));
                                                  strncpy(tmp_str26383, src + 1, tmp_strlen26383 - 1);
                                                  tmp_str26383[tmp_strlen26383 - 1] = 0;
                                                  return (Next_results){tmp_str26383, TOK_SUB, "-"};
                                                } else {
                                                  if (StartsWith(src, "*")) {
                                                    int tmp_strlen26309 = (strlen(src)) - (1) + 1;
                                                    char* tmp_str26309 = calloc(tmp_strlen26309, sizeof(char));
                                                    strncpy(tmp_str26309, src + 1, tmp_strlen26309 - 1);
                                                    tmp_str26309[tmp_strlen26309 - 1] = 0;
                                                    return (Next_results){tmp_str26309, TOK_MUL, "*"};
                                                  } else {
                                                    if (StartsWith(src, "/")) {
                                                      ...
                                                      return (Next_results){tmp_str26235, TOK_DIV, "/"};
                                                    } else {
                                                      if (StartsWith(src, "%")) {
                                                        int tmp_strlen26161 = (strlen(src)) - (1) + 1;
                                                        char* tmp_str26161 = calloc(tmp_strlen26161, sizeof(char));
                                                        strncpy(tmp_str26161, src + 1, tmp_strlen26161 - 1);
                                                        tmp_str26161[tmp_strlen26161 - 1] = 0;
                                                        return (Next_results){tmp_str26161, TOK_REM, "%"};
                                                      } else {
                                                        if (StartsWith(src, "~")) {
                                                          int tmp_strlen26087 = (strlen(src)) - (1) + 1;
                                                          char* tmp_str26087 = calloc(tmp_strlen26087, sizeof(char));
                                                          strncpy(tmp_str26087, src + 1, tmp_strlen26087 - 1);
                                                          tmp_str26087[tmp_strlen26087 - 1] = 0;
                                                          return (Next_results){tmp_str26087, TOK_INOT, "~"};
                                                        } else {
                                                          if (StartsWith(src, "|")) {
                                                            int tmp_strlen26012 = (strlen(src)) - (1) + 1;
                                                            char* tmp_str26012 = calloc(tmp_strlen26012, sizeof(char));
                                                            strncpy(tmp_str26012, src + 1, tmp_strlen26012 - 1);
                                                            tmp_str26012[tmp_strlen26012 - 1] = 0;
                                                            return (Next_results){tmp_str26012, TOK_IOR, "|"};
                                                          } else {
                                                            if (StartsWith(src, "&")) {
                                                              int tmp_strlen25938 = (strlen(src)) - (1) + 1;
                                                              char* tmp_str25938 = calloc(tmp_strlen25938, sizeof(char));
                                                              strncpy(tmp_str25938, src + 1, tmp_strlen25938 - 1);
                                                              tmp_str25938[tmp_strlen25938 - 1] = 0;
                                                              return (Next_results){tmp_str25938, TOK_IAND, "&"};
                                                            } else {
                                                              if (StartsWith(src, "^")) {
                                                                ...
                                                                return (Next_results){tmp_str25863, TOK_IXOR, "^"};
                                                              } else {
                                                                if (StartsWith(src, "<")) {
                                                                  ...
                                                                  return (Next_results){tmp_str25788, TOK_LESS, "<"};
                                                                } else {
                                                                  if (StartsWith(src, ">")) {
                                                                    int tmp_strlen25713 = (strlen(src)) - (1) + 1;
                                                                    char* tmp_str25713 = calloc(tmp_strlen25713, sizeof(char));
                                                                    strncpy(tmp_str25713, src + 1, tmp_strlen25713 - 1);
                                                                    tmp_str25713[tmp_strlen25713 - 1] = 0;
                                                                    return (Next_results){tmp_str25713, TOK_GREATER, ">"};
                                                                  } else {
                                                                    if (IsAlpha(src[0])) {
                                                                      int i = 1;
                                                                      ...
                                                                      i = (i) - (1);
                                                                      int tmp_strlen25483 = (i) - (0) + 1;
                                                                      char* tmp_str25483 = calloc(tmp_strlen25483, sizeof(char));
                                                                      strncpy(tmp_str25483, src + 0, tmp_strlen25483 - 1);
                                                                      tmp_str25483[tmp_strlen25483 - 1] = 0;
                                                                      char* ts = tmp_str25483;
                                                                      int tt;
                                                                      if ((strcmp(ts, "fn") == 0)) {
                                                                        tt = TOK_FN;
                                                                      } else {
                                                                      ...
                                                                      int tmp_strlen24690 = (strlen(src)) - (i) + 1;
                                                                      char* tmp_str24690 = calloc(tmp_strlen24690, sizeof(char));
                                                                      strncpy(tmp_str24690, src + i, tmp_strlen24690 - 1);
                                                                      tmp_str24690[tmp_strlen24690 - 1] = 0;
                                                                      return (Next_results){tmp_str24690, tt, ts};
                                                                    } else {
                                                                      if (IsNumeric(src[0])) {
                                                                        int i = 1;
                                                                        ...
                                                                        int tmp_strlen24522 = (strlen(src)) - (i) + 1;
                                                                        char* tmp_str24522 = calloc(tmp_strlen24522, sizeof(char));
                                                                        strncpy(tmp_str24522, src + i, tmp_strlen24522 - 1);
                                                                        tmp_str24522[tmp_strlen24522 - 1] = 0;
                                                                        int tmp_strlen24502 = (i) - (0) + 1;
                                                                        char* tmp_str24502 = calloc(tmp_strlen24502, sizeof(char));
                                                                        strncpy(tmp_str24502, src + 0, tmp_strlen24502 - 1);
                                                                        tmp_str24502[tmp_strlen24502 - 1] = 0;
                                                                        return (Next_results){tmp_str24522, TOK_INTLIT, tmp_str24502};
                                                                      } else {
                                                                        if (StartsWith(src, "\"")) {
                                                                          int i = 1;
                                                                          while (true) {
                                                                            int tmp_strlen24420 = ((i) + (1)) - (i) + 1;
                                                                            char* tmp_str24420 = calloc(tmp_strlen24420, sizeof(char));
                                                                            strncpy(tmp_str24420, src + i, tmp_strlen24420 - 1);
                                                                            tmp_str24420[tmp_strlen24420 - 1] = 0;
                                                                            if (!((strcmp(tmp_str24420, "\"") != 0))) break;
                                                                            i = (i) + (1);
                                                                            int tmp_strlen24359 = (i) - ((i) - (1)) + 1;
                                                                            char* tmp_str24359 = calloc(tmp_strlen24359, sizeof(char));
                                                                            strncpy(tmp_str24359, src + (i) - (1), tmp_strlen24359 - 1);
                                                                            tmp_str24359[tmp_strlen24359 - 1] = 0;
                                                                            if ((strcmp(tmp_str24359, "\\") == 0)) {
                                                                              i = (i) + (1);
                                                                            }
                                                                          }
                                                                          i = (i) + (1);
                                                                          int tmp_strlen24257 = (strlen(src)) - (i) + 1;
                                                                          char* tmp_str24257 = calloc(tmp_strlen24257, sizeof(char));
                                                                          strncpy(tmp_str24257, src + i, tmp_strlen24257 - 1);
                                                                          tmp_str24257[tmp_strlen24257 - 1] = 0;
                                                                          int tmp_strlen24237 = (i) - (0) + 1;
                                                                          char* tmp_str24237 = calloc(tmp_strlen24237, sizeof(char));
                                                                          strncpy(tmp_str24237, src + 0, tmp_strlen24237 - 1);
                                                                          tmp_str24237[tmp_strlen24237 - 1] = 0;
                                                                          return (Next_results){tmp_str24257, TOK_STRLIT, tmp_str24237};
                                                                        } else {
                                                                          int tmp_strlen24172 = (1) - (0) + 1;
                                                                          char* tmp_str24172 = calloc(tmp_strlen24172, sizeof(char));
                                                                          strncpy(tmp_str24172, src + 0, tmp_strlen24172 - 1);
                                                                          tmp_str24172[tmp_strlen24172 - 1] = 0;
                                                                          int tmp_strlen24169 = strlen("unexpected token start: ") + strlen(tmp_str24172) + 1;
                                                                          char* tmp_str24169 = calloc(tmp_strlen24169, sizeof(char));
                                                                          strcpy(tmp_str24169, "unexpected token start: ");
                                                                          strcat(tmp_str24169, tmp_str24172);
...
TranslateAssignStmt_results TranslateAssignStmt(char* src, char* indent) {
  int x = Find(src, "=");
  int tmp_strlen13186 = (x) - (0) + 1;
  char* tmp_str13186 = calloc(tmp_strlen13186, sizeof(char));
  strncpy(tmp_str13186, src + 0, tmp_strlen13186 - 1);
  tmp_str13186[tmp_strlen13186 - 1] = 0;
  char* lhs = tmp_str13186;
  int tmp_strlen13153 = (strlen(src)) - ((x) + (1)) + 1;
  char* tmp_str13153 = calloc(tmp_strlen13153, sizeof(char));
  strncpy(tmp_str13153, src + (x) + (1), tmp_strlen13153 - 1);
  tmp_str13153[tmp_strlen13153 - 1] = 0;
  char* rhs = tmp_str13153;
  char* lhs_ident;
...
int main() {
  ...
  int tmp_strlen38 = ((strlen(src_file)) - (3)) - (0) + 1;
  char* tmp_str38 = calloc(tmp_strlen38, sizeof(char));
  strncpy(tmp_str38, src_file + 0, tmp_strlen38 - 1);
  tmp_str38[tmp_strlen38 - 1] = 0;
  int tmp_strlen9 = strlen(tmp_str38) + strlen(".B.c") + 1;
  char* tmp_str9 = calloc(tmp_strlen9, sizeof(char));
  strcpy(tmp_str9, tmp_str38);
  strcat(tmp_str9, ".B.c");
  write(tmp_str9, out);
}
